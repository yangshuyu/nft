...
def custom_output_json(data, code, headers=None):
    ...
    response_code = headers.pop("response_code", 0)
    message = headers.pop("message", "")
    if 200 <= code < 300:
        custom_data = {"data": data, "code": response_code, "message": message}
    else:
        custom_data = data
    if _extra_data:
...
class CustomApi(Api):
    def __init__(self, *args, **kwargs):
        ...
        self.representations = {"application/json": custom_output_json}
